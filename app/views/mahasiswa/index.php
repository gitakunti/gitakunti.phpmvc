        ...
        <div class="col-lg-6">
            <h3> Daftar Mahasiswa </h3>
             ...
             <?php foreach( $data['mhs'] as $mhs ) : ?>
                 ...
                 <a href="<?= BASEURL; ?>/mahasiswa/ubah/<?= $mhs['id']; ?>" class="badge bg-success float-right ml-1 tampilModalUbah" data-toggle="modal" data-target="#formModal" data-id="<?=$mhs['id']; ?>">ubah</a>
